...
public class DataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
        ...
        primaryJpaProperties.put("hibernate.dialect", hibernate_dialect);
        primaryJpaProperties.put("hibernate.hbm2ddl.auto", ddl_auto);
        primaryJpaProperties.put("hibernate.id.new_generator_mappings", generator_mappings);
        primaryJpaProperties.put("hibernate.show_sql", show_sql);
        primaryJpaProperties.put("hibernate.format_sql", format_sql);
